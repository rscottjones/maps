...
See the Quest Starter Data folder for yaml files to get you started with a number of possible travel quests. These were generated by ChatGPT, Claude, or Gemini and may contain errors or omissions, but are intended to be a helpful starting point.
